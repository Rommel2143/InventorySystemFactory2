...
Public Class incoming_delivery_rpt
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "incoming_delivery_rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory_System_F2.incoming_delivery_rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedincoming_delivery_rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As incoming_delivery_rpt = New incoming_delivery_rpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
